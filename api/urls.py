...
urlpatterns = [
    ...
    path('workspaces/<int:pk>/', views.WorkspaceViewSet.as_view({
    ...
    path('workspaces/<int:workspace_id>/systems/<int:pk>/', views.SystemViewSet.as_view({
        'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy',
    })),

    path('systems/<int:system_id>/tables/', views.TableViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('systems/<int:system_id>/tables/<int:pk>/', views.TableViewSet.as_view({
        'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy',
    })),

    path('tables/<int:table_id>/records/', views.RecordViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('tables/<int:table_id>/records/<int:pk>/', views.RecordViewSet.as_view({
        'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy',
    })),
